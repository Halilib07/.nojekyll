...
class DroneHarita(QMainWindow):
    ...
    def en_yakina_isle_guncelle(self, veri):
        ...
        # 📌 YENİ: Fotoğrafları tarihe göre sırala (önce en eski)
        updated_photo_info.sort(key=lambda x: x[5] if len(x) > 5 and x[5] else "")
        ...
        # 📌 YENİ: Tarih bilgisini de al (6. eleman)
        for i, item in enumerate(updated_photo_info):
            # item uzunluğuna göre elemanları al
            if len(item) >= 6:
    ...
    def fotograflari_yukle(self):
        ...
        # ========== 📌 BURAYA SIRALAMA KODUNU EKLEYİN ==========
        # Fotoğrafları tarihe göre sırala (önce en eski)
        ...
        <script>
            ...
            function tumFotolariCikar() {{
                ...
                for (var k = 0; k < tumFotograflar.length; k++) {{
                    ...
                    if (photoInfoObj) {{
                        ...
                        // DOĞRU SATIR - tarih doğru yazıldı
            ...
            function addPhotoToDirek(direkId, fullPath) {{
                ...
                if (direk) {{
                    ...
                    console.log(`✅ Fotoğraf eklendi: ${{fullPath}} -> ${{direkId}} (Numara: ${{direk.numara}})`);
                }} else {{
